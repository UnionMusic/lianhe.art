...
const IndexPage: NextPage = () => (
  <Layout title="Home | Next.js + TypeScript Example">
    ...
    <div className="flex items-center">
      <div>
        <p className="font-semibold text-5xl">数字版权管理平台</p>
        <div className="mb-8 mt-2 font-thin">DIGITAL RIGHTS MANAGEMENT PLATFORM</div>
        <p className="font-light text-xl">提供企业/个人一站式版权管理</p>
        <p className="font-light text-xl">发行 | 结算服务</p>
        <button className="mt-8 font-light text-xl px-8 py-2 transition duration-700 ease-in-out rounded text-white bg-primary hover:bg-opacity-80 center">
          选择我们
        </button>
      </div>
      <div className="ml-auto">
        <Image src="/imgs/index.png" alt="Picture of the author" width={400} height={400} />
      </div>
    </div>
    ...
    <div className="flex flex-col">
      <div className="text-xl bg-primary text-white px-8 py-2 my-0 mx-auto">WHAT WE CAN DO</div>
      <div className="flex items-center">
        <div>
